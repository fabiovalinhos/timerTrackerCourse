...
import 'package:timer_tracker_flutter_course/app/sign_in/email_sign_in_form_stateful.dart';
...
void main() {
  ...
  group('register', () {
    testWidgets(
        'WHEN user taps on the secondary button THEN forms toggles to '
        'registration mode', (WidgetTester tester) async {
      await pumpEmailSignInForm(tester);
    ...
    testWidgets(
        ...
        'is called', (WidgetTester tester) async {
      await pumpEmailSignInForm(tester);
