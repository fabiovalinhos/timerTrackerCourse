...
import 'package:timer_tracker_flutter_course/common_widgets/date_time_picker.dart';
...
class _EntryPageState extends State<EntryPage> {
  ...
  Entry _entryFromState() {
    ...
    final id =
        widget.entry?.id ?? FirestoreDatabase.documentIdFromCurrentDate();
    return Entry(
      id: id,
      jobId: widget.job.id,
      start: start,
  ...
  Widget _buildStartDate() {
    return DateTimePicker(
      ...
      onSelectedtDate: (date) => setState(() => _startDate = date),
  ...
  Widget _buildEndDate() {
    return DateTimePicker(
      ...
      onSelectedtDate: (date) => setState(() => _endDate = date),
